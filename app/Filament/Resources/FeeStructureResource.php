...
class FeeStructureResource extends Resource
{
    ...
    {
        return $form->schema([
            Forms\Components\Select::make('academic_year_id')->label('Academic year')->options(fn () => AcademicYear::query()->pluck('name', 'id'))->required()->searchable(),
            ...
            Forms\Components\Repeater::make('fees')->relationship()->schema([
                ...
                Forms\Components\Select::make('type')->options(['registration' => 'Registration', 'tuition' => 'Tuition', 'uniform' => 'Uniform', 'canteen' => 'Canteen', 'transport' => 'Transport', 'exam' => 'Exam', 'other' => 'Other'])->default('tuition')->required(),
    ...
    public static function table(Table $table): Table
    {
        return $table->columns([
            ...
            Tables\Columns\TextColumn::make('academicYear.name')->label('Year')->toggleable(isToggledHiddenByDefault: true),
