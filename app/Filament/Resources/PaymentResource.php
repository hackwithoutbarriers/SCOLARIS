...
class PaymentResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form->schema([
            ...
            Forms\Components\Select::make('payment_method')->options(['CASH' => 'Cash', 'BANK' => 'Bank', 'TMONEY' => 'T-Money', 'FLOOZ' => 'Flooz', 'OTHER' => 'Other'])->required(),
    ...
    public static function table(Table $table): Table
    {
        return $table->columns([
            Tables\Columns\TextColumn::make('student.full_name')->label('Student')->searchable()->weight('bold')->description(fn (Payment $record): string => $record->payment_method.' · '.($record->reference ?: '—'))->wrap(),
