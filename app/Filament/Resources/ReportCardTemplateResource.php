...
class ReportCardTemplateResource extends Resource
{
        ...
        return $form->schema([
            ...
            Forms\Components\Textarea::make('schema')->label('Configuration du modèle (JSON)')->required()
                ...
                ->dehydrateStateUsing(function ($state) {
                    ...
                    if (! is_array($decoded)) {
                        throw ValidationException::withMessages(['schema' => 'The template configuration must be valid JSON.']);
                    }
    ...
    {
        return ['index' => Pages\ListReportCardTemplates::route('/'), 'create' => Pages\CreateReportCardTemplate::route('/create'), 'edit' => Pages\EditReportCardTemplate::route('/{record}/edit')];
    }
}
