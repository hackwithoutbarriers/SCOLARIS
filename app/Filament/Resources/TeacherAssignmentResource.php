...
class TeacherAssignmentResource extends Resource
{
    ...
    public static function table(Table $table): Table { return $table->columns([
        Tables\Columns\TextColumn::make('teacher.name'), Tables\Columns\TextColumn::make('classRoom.name')->label('Class'), Tables\Columns\TextColumn::make('subject.name')->label('Subject'), Tables\Columns\TextColumn::make('academicYear.name')->label('Year'),
